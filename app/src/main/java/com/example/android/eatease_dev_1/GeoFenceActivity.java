...
public class GeoFenceActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,ResultCallback<Status>,OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSharedPreferences = getSharedPreferences("com.example.android.eatease_dev_1.SHARED_PREFERENCES_NAME",
                MODE_PRIVATE);
    ...
    public static class ErrorDialogFragment extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ((GeoFenceActivity)getActivity()).onDialogDismissed();
        }
    }
    ...
    public void onResult(Status status) {
        if (status.isSuccess()) {
            ...
            editor.putBoolean("com.example.android.eatease_dev_1.GEOFENCES_ADDED_KEY", mGeofencesAdded);
            editor.commit();
